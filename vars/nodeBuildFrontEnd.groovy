...
//========================================================================
    ...
    stage ("Trivy Scan") {
        script {
            ...
            sh "trivy filesystem --ignore-unfixed --vuln-type os,library --format template --template '@${WORKSPACE}/html.tpl' -o reports/nodjs-scan.html ${WORKSPACE}/src/${buildFolder}"
            publishHTML target : [
                allowMissing: true,
